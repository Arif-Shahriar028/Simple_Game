...
public class SimpleGame2 extends JFrame implements ActionListener{
	...
	private int p2 =0, p3 =0, p4 =0, police, babu, chur, dakat, flag;
	...
	public void YouBabu()
	{
		...
		dakat = 1;
		police = 1;
		while(chur==dakat||dakat==police||chur==police)
		{
			chur = ran.nextInt(3);
			dakat = ran.nextInt(3);
		...
		//int person = ran.nextInt(3);
				...
				if(option == 0)
				{
					JOptionPane.showMessageDialog(null, "Player "+(police+2)+  " was police and he guess right");
					if(police==0)
					{
						p2 = p2+800;
                    ...
                    JOptionPane.showMessageDialog(null, "Player "+(chur+2)+  " was Chur and got Caught");
                    JOptionPane.showMessageDialog(null, "Player "+(dakat+2)+  " was Dakat and got Caught");					
				}
					
				else
				{
					JOptionPane.showMessageDialog(null, "Player "+(police+2)+  " was police and he guess Wrong");
					JOptionPane.showMessageDialog(null, "Player "+(chur+2)+  " was Chur and he remain Safe");
					if(chur==0)
					{
						p2 = p2+600;
						textfield5.setText(""+p2);
					...
					JOptionPane.showMessageDialog(null, "Player "+(dakat+2)+  " was Dakat and he remain Safe");
					if(dakat==0)
					{
						p2 = p2+600;
						textfield5.setText(""+p2);
	...
	public void YouPolice()
	{
		...
		dakat = 1;
		babu = 1;
		while(chur==dakat || dakat == babu|| chur == babu)
		{
			chur = ran.nextInt(3);
			dakat = ran.nextInt(3);
			babu = ran.nextInt(3);
		...
		if(flag == 0)
		{    
                    JOptionPane.showMessageDialog(null, "Player "+(chur+2)+  " is Chur and get Caught");
                    JOptionPane.showMessageDialog(null, "Player "+(dakat+2)+  " is Dakat and get Caught");					
		}
		else 
		{
			JOptionPane.showMessageDialog(null, "Player "+(chur+2)+  " is Chur and remain Safe");
			if(chur==0)
					{
						p2 = p2+600;
						textfield5.setText(""+p2);
			...
			JOptionPane.showMessageDialog(null, "Player "+(dakat+2)+  " is Dakat and remain Safe");
			if(dakat==0)
					{
						p2 = p2+600;
						textfield5.setText(""+p2);
	...
	public void YouChur()
	{
		...
		babu = 1;
		dakat = 1;
		 while(police==babu || babu == dakat|| police ==dakat)
		 {
			 police = ran.nextInt(3);
			 babu = ran.nextInt(3);
			 dakat = ran.nextInt(3);
	...
	public void YouDakat()
	{
		...
		babu = 1;
		chur = 1;
		 while(police==babu || babu == chur || police == chur)
		 {
			 police = ran.nextInt(3);
			 babu = ran.nextInt(3);
			 chur = ran.nextInt(3);
